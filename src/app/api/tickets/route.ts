...
export async function GET(){try{await Promise.all([requireWorkspace(),ensureSeeded()]);return Response.json({tickets:await listTickets()});}catch(e){return errorResponse(e);}}
