...
return Response.json(await listMomence(module,{query:sp.get('q')||'',page,pageSize:24,startAfter:sp.get('startAfter')||undefined,startBefore:sp.get('startBefore')||undefined,locationId,sessionTypes,upcoming:sp.get('upcoming')==='true'}));}catch(e){return errorResponse(e);}}
